...
export const AudioIndicator: FC<AudioIndicatorProps> = ({ audioTrack }) => {
	...
	return (
		<div className="relative">
			<div
				className={'h-4 w-4 rounded-full bg-blue-400 scale-[--scale]'}
				style={
					{
			...
			<div
				className={
					'h-2 w-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-200 scale-[--scale]'
				}
				style={
					{
						'--scale': Math.max(minSize, audioLevel + scaleModifier),
