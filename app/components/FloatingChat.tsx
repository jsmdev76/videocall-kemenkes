...
const FloatingChat: React.FC<CustomerServiceChatProps> = ({
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[32rem] bg-white dark:bg-gray-800 rounded-xl shadow-lg flex flex-col overflow-hidden z-50 transition-all duration-300 ease-in-out">
          <div className="bg-blue-600 text-white p-4 flex justify-between items-center">
            <h3 className="font-bold text-lg">Customer Chat</h3>
            <button
              onClick={onClose}
