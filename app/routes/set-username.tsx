		...
		<div className="grid h-full gap-4 place-content-center">
			<h1 className="text-3xl font-bold">
				...
				<svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path opacity="0.5" d="M20 10V11C20 15.4183 16.4183 19 12 19M4 10V11C4 15.4183 7.58172 19 12 19M12 19V22" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
				</svg>
				 Doctor Meets</h1>
